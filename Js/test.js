...
function displayCompletionMessage() {
    ...
    const types = [
        { type: 'ISTJ', criteria: ["c1", "a2", "c3", "a4", "c5", "a6", "b7", "b8", "c9", "c10", "a11", "b12", "c13"] },
        { type: 'ISFJ', criteria: ["a1", "b2", "a3", "b4", "a5", "b6", "a7", "b8", "a9", "b10", "c11", "a12", "b13"] },
        { type: 'INFJ', criteria: ["b1", "c2", "b3", "c4", "b5", "c6", "b7", "c8", "b9", "c10", "b11", "c12", "a13"] },
        { type: 'INTJ', criteria: ["c1", "c2", "c3", "c4", "c5", "c6", "c7", "c8", "c9", "c10", "a11", "a12", "b13"] },
        { type: 'ISTP', criteria: ["a1", "a2", "a3", "a4", "a5", "a6", "a7", "a8", "a9", "a10", "b11", "b12", "c13"] },
        { type: 'ISFP', criteria: ["b1", "b2", "b3", "b4", "b5", "b6", "b7", "b8", "b9", "b10", "c11", "a12", "a13"] },
        { type: 'INFP', criteria: ["a1", "b2", "c3", "b4", "c5", "b6", "a7", "c8", "a9", "b10", "a11", "c12", "b13"] },
        { type: 'INTP', criteria: ["c1", "a2", "b3", "a4", "b5", "a6", "c7", "b8", "c9", "a10", "b11", "c12", "a13"] },
        { type: 'ESTP', criteria: ["a1", "c2", "a3", "c4", "a5", "c6", "a7", "c8", "a9", "c10", "b11", "a12", "b13"] },
        { type: 'ESFP', criteria: ["b1", "a2", "b3", "a4", "b5", "a6", "b7", "a8", "b9", "a10", "c11", "b12", "c13"] },
        { type: 'ENFP', criteria: ["a1", "c2", "b3", "c4", "a5", "b6", "c7", "a8", "b9", "c10", "a11", "b12", "a13"] },
        { type: 'ENTP', criteria: ["b1", "b2", "a3", "a4", "c5", "c6", "b7", "b8", "a9", "a10", "c11", "a12", "c13"] },
        { type: 'ESTJ', criteria: ["c1", "b2", "c3", "b4", "c5", "b6", "c7", "b8", "c9", "b10", "a11", "c12", "a13"] },
        { type: 'ESFJ', criteria: ["a1", "a2", "b3", "b4", "a5", "a6", "b7", "b8", "a9", "a10", "b11", "a12", "c13"] },
        { type: 'ENFJ', criteria: ["b1", "c2", "a3", "c4", "b5", "c6", "a7", "b8", "c9", "a10", "b11", "c12", "a13"] },
        { type: 'ENTJ', criteria: ["c1", "b2", "a3", "b4", "a5", "c6", "b7", "a8", "b9", "c10", "a11", "b12", "c13"] }
        ];
