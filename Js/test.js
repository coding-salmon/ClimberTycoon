...
function displayCompletionMessage() {
    ...
    const types = [
        ...
        { type: 'ISTJ', criteria: ["c1", "a2", "b2", "b3", "c3", "a4", "c5", "a1", "c6", "b7", "c7", "b8", "c8", "b9", "c9", "a10", "a11", "a12","c12","b13"] },
        { type: 'ISFJ', criteria: ["c1", "a2", "b2", "b3", "c3", "a4", "b5", "c5", "a6", "c6", "c7", "c8", "b9", "a10","c10", "a11", "c12", "c13"] },
        { type: 'INFJ', criteria: ["b1", "c1", "a2", "c2", "c3", "c4", "b5", "c5", "a6", "b6", "c7", "c8", "b9", "a10", "c10", "a11", "b12", "c12", "c13"] },
        { type: 'INTJ', criteria: ["b1", "c1", "a2", "c3", "c4", "c5", "a6", "b6", "b7", "c7", "b8", "c8", "b9", "c9", "a10", "a11", "b12", "c12", "b13"] },
        { type: 'ISTP', criteria: ["c1", "b2", "b3", "c3", "a5", "a6", "c6", "a7", "b7", "b8", "c8", "b9", "c9", "a10", "b11", "c12", "b13"] },
        { type: 'ISFP', criteria: ["c1", "b2", "c2", "b3", "c3", "a4", "a5", "b5", "a6", "a7", "c8", "b9", "a10", "c10", "b11", "a12", "c12", "c13"] },
        { type: 'INFP', criteria: ["b1", "c1", "c2", "c4", "b5", "c5", "a6", "b6", "a7", "c8", "b9", "a10", "c10", "b11", "b12", "c12", "b13"] },
        { type: 'INTP', criteria: ["b1", "c1", "c3", "c4", "a5", "a6", "b6", "a7", "b7", "b8", "c8", "b9", "c9",  "a10", "b11", "b12", "c12", "b13"] },
        { type: 'ESTP', criteria: ["a1", "b2", "a3", "b3", "a4", "b4", "a5", "c6", "a7", "b7", "a8", "b8", "a9", "a9", "b10", "b11", "a12", "a13", "b13"] },
        { type: 'ESFP', criteria: ["a1", "b2", "c2", "a3", "b3", "a4", "b4", "a5", "b5", "c6", "a7", "a8", "b9", "b10", "c10", "b11", "c11", "a12", "a13", "c13"] },
        { type: 'ENFP', criteria: ["a1", "b1", "c2", "a3", "b4", "c4", "a5", "b5", "b6", "a7", "a8", "a9", "b10", "c10", "b11", "c11", "b12", "a13", "c13"] },
        { type: 'ENTP', criteria: ["a1", "b1", "a3", "b4", "c4", "a5", "b6", "a7", "b7", "a8", "b8", "a9", "c9", "b10", "c10", "b11", "b12", "a13", "b13", "c13"] },
        { type: 'ESTJ', criteria: ["a1", "a2", "b2", "a3", "b3", "a4", "b4", "c5", "c6", "b7", "c7", "a8", "b8", "a9", "c9", "b10", "a11","c11", "c12", "a13", "b13"] },
        { type: 'ESFJ', criteria: ["a1", "a2", "b2", "c2", "a3", "b3", "a4", "b4", "b5", "c5", "c6", "c7", "a8", "a9", "b10", "c10", "a11", "c11", "a12", "a13", "c13"] },
        { type: 'ENFJ', criteria: ["a1"," b1", "a2", "c2", "a3", "b4", "c4", "b5", "c5", "b6", "c7", "a8", "a9", "b10", "c10", "a11", "c11", "b12", "a13", "c13"] },
        { type: 'ENTJ', criteria: ["a1", "b1", "a2", "a3", "b4", "c4", "c5", "b6", "b7", "c7", "a8", "b8", "a9", "c9", "b10", "a11", "c11", "b12", "a13", "b13" ] }
